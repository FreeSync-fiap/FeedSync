...
public class Report {
    ...
    public Integer getTotalFeedbacksProcessed() { return totalFeedbacksProcessed; }
    public void setTotalFeedbacksProcessed(Integer totalFeedbacksProcessed) { this.totalFeedbacksProcessed = totalFeedbacksProcessed; }

    public List<ReportItem> getRecurringComments() { return recurringComments; }
    public void setRecurringComments(List<ReportItem> recurringComments) { this.recurringComments = recurringComments; }

    public List<ReportCourseAverage> getAverageByCourse() { return averageByCourse; }
    public void setAverageByCourse(List<ReportCourseAverage> averageByCourse) { this.averageByCourse = averageByCourse; }
}